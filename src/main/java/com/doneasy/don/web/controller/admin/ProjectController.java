...
import com.doneasy.don.repository.admin.project.IContentOfProjectRepository;
...
public class ProjectController {
    ...
    private final IContentOfProjectRepository contentOfProjectRepository;
    ...
    public ResponseEntity<ProjectProposal> getDetail(@PathVariable Long id) {
        ...
        ProjectProposalDetailDto projectProposalDetailDto = new ProjectProposalDetailDto(findProjectProposal.getTitle(), findProjectProposal.getTarget() == null ? null : findProjectProposal.getTarget().toString(), findProjectProposal.getService_start_date().toString(), findProjectProposal.getService_end_date().toString(), findProjectProposal.getTarget_price(), findProjectProposal.getCreated_date().toString(), findProjectProposal.getDeadline().toString(), findOrganization.getNickname(), findProjectProposal.getStatus().toString(), findContentOfProjectList);
